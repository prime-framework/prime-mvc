...
/**
 * <p> This class is the abstract control tag for the majority of the HTML controls. This class is simple in that it
 * just collects the tag attributes from the JSP and passes them along to the correct implementation of the {@link
 * Control} interface. </p>
 *
...
public abstract class AbstractHTMLControlTag<T extends Control> extends AbstractControlTag<T> {
  ...
  /**
   * Sets the tags name. This method should only be called by the container. Sub-classes should not call this name under
   * any circumstances. Instead they should use the variable directly.
   *
