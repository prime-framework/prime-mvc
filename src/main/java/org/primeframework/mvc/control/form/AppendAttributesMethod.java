...
/**
 * This class is a FreeMarker method that can be invoked within the control templates to spit out all of the attributes
 * of a tag. It takes a single parameter that is a Map&lt;?, ?> and returns a String that contains the name value pairs
 * in the format:
 * <p/>
 * <pre>
 * key=&quot;value&quot;
