...
/**
 * Abstract base action for testing {@link ValidationMethod} ordering across an inheritance hierarchy.
 ...
 */
public abstract class ValidationOrderBase {
  public List<String> invocationOrder = new ArrayList<>();

  @ValidationMethod(httpMethods = Methods.PUT)
  public void zzzValidateA() {
    invocationOrder.add("zzzValidateA");
  }

  @ValidationMethod(httpMethods = Methods.PUT)
  public void zzzValidateB() {
    invocationOrder.add("zzzValidateB");
  }
}
