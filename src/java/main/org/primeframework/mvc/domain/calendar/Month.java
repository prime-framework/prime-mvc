...
public enum Month {
  ...
  /**
   * Returns the number of days for this month in the given year. The year parameter is only applicable for february due
   * to leap years.
   *
  ...
  /**
   * Returns the month for the given integer value. This is one based so that if the value passed in is 2, then February
   * is returned.
   *
