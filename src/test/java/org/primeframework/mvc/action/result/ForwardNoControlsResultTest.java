...
import org.primeframework.mvc.action.result.ForwardNoControlsResult.ForwardNoControlsImpl;
 ...
 */
public class ForwardNoControlsResultTest {
  @Test
  public void fullyQualified() throws IOException, ServletException {
    ...
    ControllessFreeMarkerMap map = createStrictMock(ControllessFreeMarkerMap.class);
    replay(map);
    ...
    ForwardNoControls forward = new ForwardNoControlsImpl("/foo/bar.ftl", null);
    ForwardNoControlsResult forwardResult = new ForwardNoControlsResult(store, null, null, service, response, map);
  ...
  public void relative() throws IOException, ServletException {
    ...
    ForwardNoControls forward = new ForwardNoControlsImpl("bar.ftl", null);
    ForwardNoControlsResult forwardResult = new ForwardNoControlsResult(store, null, null, service, response, map);
    forwardResult.execute(forward);
  ...
  public void status() throws IOException, ServletException {
    ...
    ForwardNoControls forward = new ForwardNoControlsImpl("bar.ftl", null, "text/html; charset=UTF-8", 300);
    ForwardNoControlsResult forwardResult = new ForwardNoControlsResult(store, null, null, service, response, map);
    forwardResult.execute(forward);
  ...
  public void expansions() throws IOException, ServletException {
    ...
    ForwardNoControls forward = new ForwardNoControlsImpl("${page}", null, "${contentType}", 300);
    ForwardNoControlsResult forwardResult = new ForwardNoControlsResult(store, ee, null, service, response, map);
    forwardResult.execute(forward);
  ...
  public void contentType() throws IOException, ServletException {
    ...
    ForwardNoControls forward = new ForwardNoControlsImpl("bar.ftl", null, "text/javascript; charset=UTF-8", 200);
    ForwardNoControlsResult forwardResult = new ForwardNoControlsResult(store, null, null, service, response, map);
    forwardResult.execute(forward);
  ...
  public void search() throws IOException, ServletException {
    ...
    FreeMarkerService service = createStrictMock(FreeMarkerService.class);
    service.render(same(writer), eq("/WEB-INF/templates/action.ftl"), isA(ControllessFreeMarkerMap.class));
    replay(service);
    ...
    ForwardNoControls forward = new ForwardNoControlsImpl("", "failure");
    ForwardNoControlsResult forwardResult = new ForwardNoControlsResult(store, null, locator, service, response, map);
    forwardResult.execute(forward);
