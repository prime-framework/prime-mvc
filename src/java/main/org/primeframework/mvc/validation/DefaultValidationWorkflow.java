...
import org.primeframework.mvc.validation.annotation.ValidCollection;
import org.primeframework.mvc.validation.annotation.ValidMap;
import org.primeframework.mvc.validation.annotation.ValidateMethod;
...
public class DefaultValidationWorkflow implements ValidationWorkflow {
  ...
  /**
   * Performs the validation on the action using annotations and validate methods. If validation fails, this swaps out
   * the ActionInvocation with a dummied version that always returns the <code>input</code> result code and then
