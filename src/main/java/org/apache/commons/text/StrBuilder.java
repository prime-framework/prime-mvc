...
public class StrBuilder implements CharSequence, Appendable {
  ...
  /**
   * Appends each item in a iterable to the builder without any separators. Appending a null iterable will have no
  ...
  /**
   * Appends an object to the builder padding on the right to a fixed length. The <code>toString</code> of the object is
  ...
  /**
   * Appends part of a string followed by a new line to this string builder. Appending null will call {@link
   * #appendNull()}.
   *
   * @param str        the string to append
   * @param startIndex the start index, inclusive, must be valid
  ...
  /**
   * Appends a string buffer followed by a new line to this string builder. Appending null will call {@link
   * #appendNull()}.
   *
   * @param str the string buffer to append
   * @return this, to enable chaining
  ...
  /**
   * Appends part of a string buffer followed by a new line to this string builder. Appending null will call {@link
   * #appendNull()}.
   *
   * @param str        the string to append
   * @param startIndex the start index, inclusive, must be valid
  ...
  /**
   * Appends another string builder followed by a new line to this string builder. Appending null will call {@link
   * #appendNull()}.
   *
   * @param str the string builder to append
   * @return this, to enable chaining
  ...
  /**
   * Appends part of a string builder followed by a new line to this string builder. Appending null will call {@link
   * #appendNull()}.
   *
   * @param str        the string to append
   * @param startIndex the start index, inclusive, must be valid
   ...
   * <p>
   * Matchers can be used to perform advanced deletion behaviour. For example you could write a matcher to delete where
   ...
   * <p>
   * Matchers can be used to perform advanced behaviour. For example you could write a matcher to delete all occurances
   ...
   * <p>
   * Matchers can be used to perform advanced replace behaviour. For example you could write a matcher to replace where
   * the character 'a' is followed by a number.
   *
   * @param matcher    the matcher to use to find the deletion, null causes no action
   * @param replaceStr the replace string, null is equivalent to an empty string
