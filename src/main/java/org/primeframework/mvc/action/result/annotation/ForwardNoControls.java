...
import org.primeframework.mvc.action.result.ForwardNoControlsResult;

import static java.lang.annotation.ElementType.*;
import static java.lang.annotation.RetentionPolicy.*;

/**
 * This annotation marks a result from an action as a FreeMarker template that doesn't use any of the Prime MVC
 * controls. By not using the controls, the speed of rending the result should improve slightly.
 *
 * @author Brian Pontarelli
 */
@ResultAnnotation(ForwardNoControlsResult.class)
@Retention(RUNTIME)
@Target(TYPE)
public @interface ForwardNoControls {
  /**
