...
/**
 * <p> This class is an abstract input that is used for any input that uses a list or items. This includes select boxes
 * and checkbox groups. </p>
 *
...
public abstract class AbstractListInput extends AbstractInput {
  ...
  /**
   * <p> Handles the items and value. Here's the skinny: </p>
   * <p/>
