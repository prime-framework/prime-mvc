...
public class StrSubstitutor {
   ...
   * method allows to specifiy a custom variable prefix and suffix
   *
   * @param <V>      the type of the values in the map
   * @param source   the source text containing the variables to substitute, null returns null
   * @param valueMap the map with the values, may be null
   ...
   * <p>
   * The variable prefix is the characer or characters that identify the start of a variable. This prefix is expressed
   ...
   * <p>
   * The variable suffix is the characer or characters that identify the end of a variable. This suffix is expressed in
   ...
   * The input source object is converted to a string using <code>toString</code> and is not altered.
   *
   ...
   * Sets the variable prefix to use.
   * <p>
   * The variable prefix is the characer or characters that identify the start of a variable. This method allows a
   ...
   * <p>
   * The variable suffix is the characer or characters that identify the end of a variable. This method allows a single
   ...
   * passed the variable's name and must return the corresponding value. This implementation uses the {@link
