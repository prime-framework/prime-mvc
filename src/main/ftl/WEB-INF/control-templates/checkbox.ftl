...
<div class="control-container"><input type="checkbox"[@macros.append_attributes attributes=attributes excludes=[]/]/><input type="hidden" name="__cb_${attributes['name']}" value="${uncheckedValue?html}"/></div>
</div>
