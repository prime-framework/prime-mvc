...
import org.primeframework.servlet.JCatapultFilter;
import org.primeframework.servlet.JCatapultServletContextListener;
...
/**
 * <p>
 * This class provides a method for testing a full invocation of JCatapult. This simulates
 * the JEE web objects (HttpServletRequest, etc.) and an invocation of the JCatapultFilter.
 * You can also simulate multiple invocations across a single session by using the same
 * instance of this class multiple times.
 * </p>
 *
 * <h3>Examples</h3>
 * <pre>
...
public class RequestSimulator {
    ...
    /**
     * Creates or retrieves the singleton instance of the tester. If the singleton instance hasn't
     * been created yet, this method uses the given modules (optional) to create the singleton
     * instance and initialize it. If it has already been created, this returns the instance.
     *
    ...
    /**
     * Starts a test for the given URL. This returns a RequestBuilder that you can use to set the request
     * up correctly for the test and then execute the GET or POST.
     *
    ...
    /**
     * This method pre-initialies the Guice injector and the JCatapult singletons and statics. You
     * might consider using this method if you want to run a bunch of tests against the same Guice
     * injector. Sometimes, Guice takes a while to start up and you just want to do it once. This
     * method allows you to set everything up once and then run many tests against the same injector.
     *
