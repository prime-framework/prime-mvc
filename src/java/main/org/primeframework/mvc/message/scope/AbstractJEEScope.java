...
/**
 * <p> This class is an abstract implementation of the Scope interface. It implements all of the Scope methods and
 * forces sub-classes to simply focus on retrieving the Map and List to storage the messages from the correct location.
 * </p>
 *
