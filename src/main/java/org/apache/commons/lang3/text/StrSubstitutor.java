 ...
 * {@link #setValueDelimiterMatcher(StrMatcher)}, {@link #setValueDelimiter(char)} or
 ...
 * </pre>
 * {@code StrSubstitutor} supports this recursive substitution in variable names, but it has to be enabled explicitly by
 * setting the {@link #setEnableSubstitutionInVariables(boolean) enableSubstitutionInVariables} property to
 * <b>true</b>.
...
public class StrSubstitutor {
  ...
  /**
   * Replaces all the occurrences of variables in the given source object with their matching values from the map. This
   * method allows to specify a custom variable prefix and suffix
   *
   * @param <V>      the type of the values in the map
   * @param source   the source text containing the variables to substitute, null returns null
   * @param valueMap the map with the values, may be null
   ...
   * <p>
   * The variable default value delimiter is the character or characters that delimit the variable name and the variable
   * default value. This delimiter is expressed in terms of a matcher allowing advanced variable default value delimiter
   * matches.
   * <p>
   ...
   * <p>
   * The variable prefix is the character or characters that identify the start of a variable. This prefix is expressed
   * in terms of a matcher allowing advanced prefix matches.
   *
   ...
   * <p>
   * The variable suffix is the character or characters that identify the end of a variable. This suffix is expressed in
   * terms of a matcher allowing advanced suffix matches.
   *
   ...
   * processed first before the original variable is evaluated, e.g. {@code ${jre-${java.version}}}. The default value
   * is <b>false</b>.
   *
  ...
  /**
   * Replaces all the occurrences of variables with their matching values from the resolver using the given source array
   * as a template. The array is not altered by this method.
   *
  ...
  /**
   * Replaces all the occurrences of variables with their matching values from the resolver using the given source as a
   * template. The source is not altered by this method.
   *
   * @param source the buffer to use as a template, not changed, null returns null
   * @return the result of the replace operation
   * @since 3.2
   ...
   * The input source object is converted to a string using {@code toString} and is not altered.
   *
   ...
   * resolver. The buffer is updated with the result.
   * <p>
   * Only the specified portion of the buffer will be processed. The rest of the buffer is not processed, but it is not
   * deleted.
   *
   * @param source the buffer to replace in, updated, null returns zero
   * @param offset the start offset within the array, must be valid
   ...
   * <p>
   * The variable default value delimiter is the character or characters that delimit the variable name and the variable
   * default value. This method allows a single character variable default value delimiter to be easily set.
   *
   ...
   * <p>
   * The variable default value delimiter is the character or characters that delimit the variable name and the variable
   * default value. This method allows a string variable default value delimiter to be easily set.
   * <p>
   ...
   * <p>
   * The variable suffix is the character or characters that identify the end of a variable. This method allows a single
   * character suffix to be easily set.
   *
   ...
   * Sets the variable suffix to use.
   * <p>
   * The variable suffix is the character or characters that identify the end of a variable. This method allows a string
   * suffix to be easily set.
   *
   * @param suffix the suffix for variables, not null
   * @return this, to enable chaining
