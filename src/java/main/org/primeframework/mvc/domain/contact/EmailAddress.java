 ...
 */
package org.primeframework.mvc.domain.contact;
...
/**
 * <p> This class is a simple address object that provides just a few helper methods for picking apart address Strings.
 * </p>
 *
...
public class EmailAddress implements Serializable {
  ...
  /**
   * @return Returns the host portion of the address address. This is the part after the at sign. (for example,
   *         bob@example.com would return example.com)
   */
  ...
  /**
   * @return Returns the account portion of the address address. This is the part before the at sign. (for example,
   *         bob@example.com would return bob).
   */
