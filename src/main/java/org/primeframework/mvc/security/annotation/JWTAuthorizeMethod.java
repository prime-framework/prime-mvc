...
/**
 * When {@link Action#jwtEnabled()} is set to true, <code>POST</code>, <code>PUT</code>, <code>DELETE</code> and <code>GET</code> all need
 ...
 * <p/>
 * Required when {@link Action#jwtEnabled()} is set to true. This method will be called and expect a true or false return value to indicate
