...
<div class="control-container"><input type="checkbox"[@macros.append_attributes attributes=attributes list=[]/]/><input type="hidden" name="__cb_${attributes['name']}" value="${uncheckedValue?html}"/></div>
</div>
