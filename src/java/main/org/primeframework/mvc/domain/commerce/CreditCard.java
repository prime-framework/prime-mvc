...
/**
 * <p> This class stores the credit card information used during transaction processing. </p>
 *
...
public class CreditCard implements Serializable {
  ...
  /**
   * @return A displayable partial number for the credit card that contains 10 astrixes and the last 4 digits from the
   *         card.
   */
  ...
  /**
   * A transient value for the security verification number on the back of the card. This is transient in the fact that
   * it cannot be persited via JPA. It can however be serialized.
   *
   * @return The SVN.
   */
  ...
  /**
   * @return Uses the standard credit card validation to determine if this credit card is valid or not. This method can
   *         easily be found online by searching for "credit card validation".
   */
  ...
  /**
   * Compares the address to the object for equality. This comparison uses the number, expiration month and year, first
   * and last names, and the address.
   *
  ...
  /**
   * Generates a hash code using the number, expiration month and year, first and last names, and the address.
   *
  ...
  /**
   * Outputs a String for debugging. This includes the number in full because it is often necessary to help debug
   * gateway issues. However, you should never use this in production.
   *
