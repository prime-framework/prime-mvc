...
public interface MessageStore {
    /**
     * Usually called by the {@link org.primeframework.mvc.parameter.ParameterWorkflow}, this method adds
    ...
    /**
     * Adds a file upload size error, which is pulled from the {@link org.primeframework.l10n.MessageProvider}.The
    ...
    /**
     * Adds a file content type error, which is pulled from the {@link org.primeframework.l10n.MessageProvider}.The
     * uri used to look up the message is the current request URI.
     *
     * @param   field The field that the file was being set into.
     * @param   uri The request URI.
    ...
    /**
     * Adds a field message, which is pulled from the {@link org.primeframework.l10n.MessageProvider}.
     *
    ...
    /**
     * Adds a field message, which is pulled from the {@link org.primeframework.l10n.MessageProvider}. The
     * uri used to look up the message is the current request URI.
     *
     * @param   scope The scope that the message should be placed into.
     * @param   field The field that the message is associated with.
    ...
    /**
     * Adds a field error, which is pulled from the {@link org.primeframework.l10n.MessageProvider}.
     *
    ...
    /**
     * Adds a field error, which is pulled from the {@link org.primeframework.l10n.MessageProvider}.The
     * uri used to look up the message is the current request URI.
     *
     * @param   scope The scope that the error should be placed into.
     * @param   field The field that the error is associated with.
    ...
    /**
     * Adds an action message, which is pulled from the {@link org.primeframework.l10n.MessageProvider}.
     *
     * @param   scope The scope that the message should be placed into.
     * @param   uri The URI (path) that is used to locate the bundle to pull the error from.
     * @param   key The key in the bundle.
    ...
    /**
     * Adds an action message, which is pulled from the {@link org.primeframework.l10n.MessageProvider}. The
     * uri used to look up the message is the current request URI.
     *
     * @param   scope The scope that the message should be placed into.
     * @param   key The key in the bundle.
    ...
    /**
     * Adds an action error which is pulled from the {@link org.primeframework.l10n.MessageProvider}.
     *
     * @param   scope The scope that the error should be placed into.
     * @param   uri The URI (path) that is used to locate the bundle to pull the error from.
     * @param   key The key in the bundle.
    ...
    /**
     * Adds an action error, which is pulled from the {@link org.primeframework.l10n.MessageProvider}.The
     * uri used to look up the message is the current request URI.
     *
     * @param   scope The scope that the error should be placed into.
     * @param   key The key in the bundle.
