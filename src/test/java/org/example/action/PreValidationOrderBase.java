...
/**
 * Abstract base action for testing {@link PreValidationMethod} ordering across an inheritance hierarchy.
 ...
 */
public abstract class PreValidationOrderBase {
  public List<String> invocationOrder = new ArrayList<>();

  @PreValidationMethod
  public void zzzPreA() {
    invocationOrder.add("zzzPreA");
  }

  @PreValidationMethod
  public void zzzPreB() {
    invocationOrder.add("zzzPreB");
  }
}
