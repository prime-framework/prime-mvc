...
/**
 * <p> This interface defines the mechanism by which errors are added and fetched. </p>
 *
...
public interface MessageStore {
  /**
   * Usually called by the {@link org.primeframework.mvc.parameter.ParameterWorkflow}, this method adds a conversion
   * error for the given parameter. The values can be token replaced within the localized error message.
   *
   ...
   * @param dynamicAttributes The dynamic attributes, which might be useful for error messaging stuff.
  ...
  /**
   * Adds a file upload size error, which is pulled from the {@link MessageProvider}.The uri used to look up the message
   * is the current request URI.
   *
   * @param field The field that the file was being set into.
   * @param uri   The request URI.
   * @param size  The file size that was too large. @throws  MissingMessageException If the file size message is
   *              missing.
   */
  void addFileUploadSizeError(String field, String uri, long size) throws MissingMessageException;

  /**
   * Adds a file content type error, which is pulled from the {@link MessageProvider}.The uri used to look up the
   * message is the current request URI.
   *
   * @param field       The field that the file was being set into.
   * @param uri         The request URI.
  ...
  /**
   * Adds a field message, which is pulled from the {@link MessageProvider}. The uri used to look up the message is the
   * current request URI.
   *
   * @param scope  The scope that the message should be placed into.
   * @param field  The field that the message is associated with.
  ...
  /**
   * Adds a field error, which is pulled from the {@link MessageProvider}.The uri used to look up the message is the
   * current request URI.
   *
   * @param scope  The scope that the error should be placed into.
   * @param field  The field that the error is associated with.
  ...
  /**
   * Adds an action message, which is pulled from the {@link MessageProvider}. The uri used to look up the message is
  ...
  /**
   * Adds an action error, which is pulled from the {@link MessageProvider}.The uri used to look up the message is the
   * current request URI.
   *
   * @param scope  The scope that the error should be placed into.
   * @param key    The key in the bundle.
