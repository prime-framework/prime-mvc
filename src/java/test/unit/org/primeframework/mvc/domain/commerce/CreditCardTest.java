...
/**
 * <p> This is a test class for the credit card domain object. </p>
 *
...
public class CreditCardTest {
  ...
  /**
   * Test that the leap year code is working properly and that it always grab the last day of the month.
   */
  @Test
