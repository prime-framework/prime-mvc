 ...
 * to occur during an HTTP request rather than defining HTTP filters in web.xml.
 * The JCatapultFilter uses this interface to determine the list of {@link Workflow}
 * implementations to invoke and the order to invoke them in.
 * </p>
 *
...
public interface WorkflowResolver {
     ...
     * method in order to get the list of Workflow implementations that should be invoked.
     *
    ...
    /**
     * Called in the {@link org.primeframework.servlet.JCatapultFilter#destroy()} method in order to get
