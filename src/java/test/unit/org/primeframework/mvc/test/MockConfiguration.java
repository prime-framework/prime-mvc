...
/**
 * <p> This is a mock configuration object that delegates to another PrimeMVCConfiguration instance, but also allows
 * specific properties to be mocked out. This can be used in a unit tests via a little glue like this: </p>
 * <p/>
 * <pre>
 *
