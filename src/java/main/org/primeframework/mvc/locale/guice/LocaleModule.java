...
/**
 * <p> This class is a Guice module for injecting the current Locale into classes. </p>
 *
 * @author Brian Pontarelli
 */
public class LocaleModule extends AbstractModule {
  /**
   * Sets up the Locale so that it can be injected when the {@link CurrentLocale} annotation is used. The injection is
   * handled by the {@link DefaultLocaleStore} class.
   */
