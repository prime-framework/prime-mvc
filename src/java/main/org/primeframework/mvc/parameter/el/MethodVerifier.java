...
public interface MethodVerifier {
  /**
   * Verifies if the property method is valid or not. The BeanPropertyInfo in case anything additional about the
   * property is needed.
   *
   ...
   * @return The type and never null. This method is called after the isValid method is called and therefore the method
   *         is valid.
   */
