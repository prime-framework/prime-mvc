...
public class LocaleUtils {
   ...
   * It is more efficient, as the JDK method must create a new array each time it is called.</p>
   *
   ...
   * next more general and so on, finishing with the default locale. The list will never contain the same locale
   * twice.</p>
   *
