...
/**
 * <p>
 * This class verifies JavaBean standard setter methods. The forms of the
...
public class SetMethodVerifier implements MethodVerifier {
    ...
    /**
     * Check if the method is a proper java bean setter-property method. This means that it starts with
     * set, has the form setFoo or setFOO, takes a single parameter and returns void
     *
    ...
    /**
     * Check if the method is a proper java bean indexed setter method. This means that it starts with
     * set, has the form setFoo or setFOO, takes a two parameters, an indices and a value and returns
     * void.
     *
     * @param   method The method to check.
     * @return  True if valid, false otherwise.
    ...
    /**
     * Using the propertyName, returns the Java Bean standard setter method name. If the parameter
     * String starts with white space or only contains white space or is empty, the it is simply
     * concatenated to the SET constant of this class. It is the job of the calling code to make
